...
> = {
  members: {
    ...
    description: `RIVIO is India's pay-per-day fitness platform founded by ${FOUNDER_NAME}. Discover gyms, yoga & wellness venues, check in with QR, pay only for days you use — no long-term subscription. Member app on App Store & Google Play.`,
    h1Context:
