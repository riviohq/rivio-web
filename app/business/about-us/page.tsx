        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-2xl md:text-3xl text-amber-400 mb-4 font-semibold">
              Gym &amp; Studio Business App for India
            </p>
          ...
          <div className="bg-gradient-to-br from-amber-500/10 to-emerald-500/10 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-amber-500/20 shadow-2xl">
            ...
            <div className="space-y-4 text-lg text-gray-300 leading-relaxed">
              <p>
                ...
                tracking, pass management, earnings visibility, and settlements. It is the operational backbone for
              ...
              <p>
                ...
                <Link href="/pulse/" className="text-amber-400 font-semibold hover:underline">
                  Rivio Pulse
                </Link>
                , learn about{' '}
                <Link href="/founder/" className="text-amber-400 font-semibold hover:underline">
        ...
        <section className="mb-20">
          <div className="bg-gradient-to-br from-amber-500/10 to-amber-600/10 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-amber-500/20 shadow-2xl">
            ...
            <div className="space-y-6 text-lg text-gray-300 leading-relaxed">
              ...
              <p>The fitness and wellness industry is built on passion, dedication, and the power of community. Yet we saw that business owners, the very people creating these experiences, were being held back by technology that was supposed to help them.</p>
